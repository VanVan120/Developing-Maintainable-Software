...
/**
 * Small immutable holder describing a preview shape and its horizontal position.
 * The internal matrix is defensively copied on construction and when returned to
 * callers to avoid external mutation.
 */
